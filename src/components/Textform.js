...
const handleOnchange= (event)=>{
  ...
  <button type="submit" onClick={onclickUPhandle} className="btn btn-primary mx-2">Capitalise</button>
  <button type="submit" onClick={lowHandle} className="btn btn-primary mx-1">LowerCase</button>
  <button type="submit" onClick={clearHandle} className="btn btn-primary mx-1">clear</button>
  <button type="submit" onClick={copyHandle}  className="btn btn-primary mx-1">Copy</button>
